...
let CSSImagePipe = class CSSImagePipe {
    constructor(renderer, preloader, sanitizer) {
        this.renderer = renderer;
        this.preloader = preloader;
        this.sanitizer = sanitizer;
    }
    transform(url, id, repeat, molded) {
        let style = '';
        if (molded) {
            const img = this.preloader.image(id, url);
...
let IselectSanitizePipe = class IselectSanitizePipe {
...
IselectSanitizePipe.ctorParameters = () => [
    { type: DomSanitizer }
];
